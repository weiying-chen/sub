...
describe("loadProperNouns", () => {
  it("includes key Buddhist terms in the default proper noun list", async () => {
    ...
    expect(properNouns).toContain("Latin America")
    expect(properNouns).toContain("Japan")
    expect(properNouns).toContain("Jing Si Aphorisms")
    expect(properNouns).toContain("Graciela")
    ...
    expect(properNouns).toContain("Ecuador")
    ...
    expect(properNouns).toContain("Nanjichang")
    expect(properNouns).toContain("Nanjichang Borough Chief")
    expect(properNouns).toContain("Borough Chief Fang")
    ...
    expect(properNouns).toContain("Jing Nian")
    expect(properNouns).toContain("Stephen Huang")
    ...
    expect(properNouns).toContain("Level")
  })
})
